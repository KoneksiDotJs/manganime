...
const Page = ({ params }: { params: { episodeId: string } }) => {
  ...
  const isOvaPage =
    typeof window !== "undefined" && window.location.pathname.includes("ova");
    ...
    <div className="py-10">
      ...
      {episode && (
        <>
          ...
          {showMessage && (
            <div
              className="alert alert-danger bg-green-500 text-black mx-auto max-w-full"
              role="alert"
              style={{ display: "flex", justifyContent: "space-between" }}
            >
              <span className="mx-auto">
                720p tidak selalu ada karena limitasi akses ke server sumber
              </span>
              <button
          ...
          <span className="flex justify-center">
            Kualitas saat ini: {selectedQuality}
          </span>
          ...
          <div className="mt-3 text-center">
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded clickAnimation"
            >
              {showComments
                ? "Tutup Komentar & React"
                : "Buka Komentar & React"}
            </button>
          </div>
